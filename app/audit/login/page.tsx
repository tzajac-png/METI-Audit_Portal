...
export default function AuditLoginPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      window.location.assign("/audit/courses");
    } catch {
  ...
  return (
    <div className="mx-auto max-w-md pt-10">
      <div className="rounded-xl border border-red-900/40 bg-[var(--surface)] p-8 shadow-xl shadow-black/50">
        <h1 className="text-xl font-semibold text-white">Administration audit</h1>
        <p className="mt-2 text-sm text-zinc-400">
          Enter the audit password to review and record course data.
        </p>
